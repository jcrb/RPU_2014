...
<!--html_preserve--><div id="htmlwidget-4300" style="width:672px;height:480px;" class="dygraphs"></div>
<script type="application/json" data-for="htmlwidget-4300">{ "x": {
 "attrs": {
 "title": "SU 2014",
"ylabel": "Affaires",
"labels": [ "day", "passages.jour", "hospit.jour", "mutations.jour", "transfert.jour", "taux.hosp" ],
"legend": "auto",
"axes": {
 "x": {
 "pixelsPerLabel":                50 
