...
```{}
d09 <- dx[as.Date(dx$ENTREE) >= "2014-09-01" & as.Date(dx$ENTREE) < "2014-10-01",]
max(as.Date(d09$ENTREE))
min(as.Date(d09$ENTREE))
d09 <- normalise(d09)
save(d09, file="rpu2014d09_provisoire.Rda")
rm(dx)

load("rpu2014d0108.Rda")

dx <- rbind(dx, d09)
min(as.Date(dx$ENTREE))
max(as.Date(dx$ENTREE))

save(dx, file="rpu2014d0109_provisoire.Rda")
