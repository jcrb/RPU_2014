...
```{}
d10 <- dx[as.Date(dx$ENTREE) >= "2014-10-01" & as.Date(dx$ENTREE) < "2014-11-01",]
max(as.Date(d10$ENTREE))
min(as.Date(d10$ENTREE))
d10 <- normalise(d10)
save(d10, file="rpu2014d10_provisoire.Rda")
rm(dx)
...
save(dx, file="rpu2014d0110_provisoire.Rda")

table(as.Date(d10$ENTREE), d10$FINESS)
```
