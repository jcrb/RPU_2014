...
```{}
d02 <- dx[as.Date(dx$ENTREE) >= "2015-02-01" & as.Date(dx$ENTREE) < "2015-03-01",]
max(as.Date(d02$ENTREE))
min(as.Date(d02$ENTREE))
d02 <- normalise(d02)
save(d02, file="rpu2015d02_provisoire.Rda")
rm(dx)
...
dx <- rbind(d15, d01)
min(as.Date(d15$ENTREE))
max(as.Date(d15$ENTREE))

save(15, file="rpu2015d0112_provisoire.Rda")
...
# sauvegarde
save(d01.p, file = "d01_provisoire.Rda")
...
plot(xts.a, las = 2, main = "Activité des SU d'Alsace", ylab = "nombre de RPU créés")
mean2014 <- 1141.734
sd2014 <- 154.7858
