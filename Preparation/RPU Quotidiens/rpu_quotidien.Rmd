...
table(as.Date(d02$ENTREE), d02$FINESS)
```
...
plot(xts.a, las = 2, main = "Activité des SU d'Alsace", ylab = "nombre de RPU créés par jour")
mean2014 <- 1141.734
sd2014 <- 154.7858
...
legend("topleft", legend = c("moyenne 2014", "écart-type 2014"), col = "red", lty = c(1,2), bty = "n")


```
svg("activité SU alsace 2015.svg")
plot()
dev.off()
