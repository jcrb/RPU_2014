...
```{}
d03 <- dx[as.Date(dx$ENTREE) >= "2015-04-01" & as.Date(dx$ENTREE) < "2015-05-01",]
max(as.Date(d04$ENTREE))
min(as.Date(d04$ENTREE))
d04 <- normalise(d04)
save(d04, file="rpu2015d04_provisoire.Rda")
rm(dx)

# si le mois est complet:
#s ave(d03, file="rpu2015d03.Rda")
# rm(rpu2015d03_provisoire.Rda)
