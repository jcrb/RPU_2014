...
### bilan des RPU à la ate du 31/7/2015
```{}
...
plot(xts.a, major.ticks= "weeks", minor.ticks = FALSE, major.format = "%d %b", cex.axis = 0.8, las = 2, main = "Activité des SU d'Alsace", ylab = "nombre de RPU créés par jour", ylim = c(900,1700))
mean2014 <- 1141.734
sd2014 <- 154.7858
