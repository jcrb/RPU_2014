...
```{}
d03 <- dx[as.Date(dx$ENTREE) >= "2015-03-01" & as.Date(dx$ENTREE) < "2015-04-01",]
max(as.Date(d03$ENTREE))
min(as.Date(d03$ENTREE))
d03 <- normalise(d03)
save(d03, file="rpu2015d03_provisoire.Rda")
rm(dx)
...
table(as.Date(d03$ENTREE), d03$FINESS)
```
