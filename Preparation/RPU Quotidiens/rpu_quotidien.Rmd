...
#load("RPU_2014/rpu2015d0112_provisoire.Rda")
load("rpu2015d0112_provisoire.Rda") # si console
...
# Uniquement le CCOM
ccm2015 <- d15[d15$FINESS == "Ccm",]
save(ccm2015, file = "ccm2015.Rda")

# TOUS les rpu SAUF le CCOM
d15 <- d15[d15$FINESS != "Ccm",]
save(d15, file="rpu2015d0112_provisoire.Rda")
...
n.jours <- as.numeric(max(as.Date(d12$ENTREE))-min(as.Date(d12$ENTREE)) + 1)
n.rpu.mois.constant <- nrow(d12) * 30 / n.jours
n.rpu.mois.constant
...
write.csv(rpu.jour, file = "rpu.jour_27-12-2015.csv") 
...
rpu <- read.csv("rpu.jour_22-12-2015.csv")
names(rpu)[1] <- "date"
names(rpu)[2] <- "3Fr"
...
library(stringr)
pattern <- "[W][3][9]"
p <- d15.p[str_detect(d15.p$DP, pattern) == TRUE,] # il faut éliminer les NA
n.p <- nrow(p)
# Age
summary(p$AGE)
# Sexe
