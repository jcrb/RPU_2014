...
```{}
d11 <- dx[as.Date(dx$ENTREE) >= "2015-11-01" & as.Date(dx$ENTREE) < "2015-12-01",]
min(as.Date(d11$ENTREE))
max(as.Date(d11$ENTREE))

d11 <- normalise(d11)
save(d11, file="rpu2015d11_provisoire.Rda")
rm(dx)
...
d15 <- d15[as.Date(d15$ENTREE) < "2015-11-01",]
