...
```{}
d12 <- dx[as.Date(dx$ENTREE) >= "2014-12-01" & as.Date(dx$ENTREE) < "2015-01-01",]
max(as.Date(d12$ENTREE))
min(as.Date(d12$ENTREE))
d12 <- normalise(d12)
save(d12, file="rpu2014d12_provisoire.Rda")
rm(dx)
...
save(dx, file="rpu2014d0112_provisoire.Rda")

table(as.Date(d12$ENTREE), d12$FINESS)
```
