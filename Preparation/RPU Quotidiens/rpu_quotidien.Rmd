...
```{}
d11 <- dx[as.Date(dx$ENTREE) >= "2014-11-01" & as.Date(dx$ENTREE) < "2014-12-01",]
...
load("rpu2014d0110.Rda")

dx <- rbind(dx, d11)
min(as.Date(dx$ENTREE))
max(as.Date(dx$ENTREE))

save(dx, file="rpu2014d0111_provisoire.Rda")

table(as.Date(d11$ENTREE), d11$FINESS)
```
