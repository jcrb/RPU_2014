...
hist(grippe$AGE, breaks = 20, main = paste0(anc, " - Syndromes grippaux"), xlab = "Age (années)", ylab = "Fréquence")

hist(grippe$AGE[grippe$AGE > 17], breaks = 20, main = paste0(anc, " - Syndromes grippaux dans la population adulte"), xlab = "Age (années)", ylab = "Fréquence")
