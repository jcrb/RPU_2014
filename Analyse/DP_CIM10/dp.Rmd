...
barplot(b, beside = TRUE, main = "Syndrome grippaux vu aux urgences en Alsace", ylab = "Fréquence", las = 2, cex.names = 0.8, col = cols)
...
plot(b, minor.ticks = FALSE, main = "Syndrome grippaux en Alsace", ylab = "Fréquence")
...
b <- c(a[1,], a[2,])
plot(b, ylab = "Fréquence", main = "Syndromes grippaux aux SU d'Alsace", type = "l")
barplot(b, ylab = "Fréquence", main = "Syndromes grippaux hebdomadaires aux SU d'Alsace", sub = "2014 - 2015")
