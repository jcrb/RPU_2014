...
# durée de passage en fonction de l'heure d'entrée
...
```{r x10, echo=FALSE}
h10 <- dpas.heure[dpas.heure$HEURE == 10,]
# moyenne
...
#'@param seuil seuil au delà duquel il y a dépassement. Ne sert pas dans ici
...
# d[1:7] <- 0
# for(i in 2:length(c2)-1){
#   d[i+7] = max(0, ec7[i] - k + d[i+7-1])}

barplot(c2, ylab = "CUSUM - C2", xlab = "Jours", main = "")
abline(h = 2, lty = 2, col = "red")

```
Le vecteur __ec7__ ne commence que le 7 janvier et ne conporte que 358 jours au lieu de 365. On nte également que les fluctuations se font entre 2SD, ce qui en fait un indicateur peu sensible.
